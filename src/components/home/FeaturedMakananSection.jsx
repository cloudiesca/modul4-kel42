...
export default function FeaturedMakananSection({ featuredMakanan, favorites, toggleFavorite, onSelectRecipe }) {
  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-6 md:mb-8">
        <h2 className="text-xl md:text-3xl font-bold text-slate-800">Resep Makanan Unggulan</h2>
          ...
          return (
            <div 
              ...
              className={`group transform transition-all duration-700 ${
                visibleMakanan.has(index) ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}
            >
